                ...
                >
                    ...
                    <View
                        ...
                        <View  style={styles.signUpTextView}>
                            <AppText
                                style={styles.signUpText}>You already have an account? </AppText><AppTextButton onPress={this._onPressLogin.bind(this)} style={styles.signUpText}> Login </AppTextButton>
                        </View>
                    </View>
                </Image>
            </SmartScrollView>
